...
export default function CalculadoraSueldoTandil() {
  ...
  // Convenio seleccionado y si tiene escalas
  ...
  if (sector === "publico") {
    ...
    if (escalaActual) {
      ...
      // NR fijo por mes si existiera en la escala (si en tu hoja lo definís por mes)
    ...
    // Bases de cálculo correctas (según tu instrucción)
    const baseRem = totalRemunerativo;                         // Jubilación / Ley 19032
    const baseRemNoRem = totalRemunerativo + totalNoRemunerativo; // OS / FAECYS / Aporte solidario
  ...
  // ⬅️ IMPORTANTE: loading previo al return principal
